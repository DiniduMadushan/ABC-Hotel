        ...
        <nav id="main-nav" class="navbar bg-dark align-items-start sidebar sidebar-dark accordion p-0" style="padding-bottom: 0px;">
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        <li class="nav-item">
                            <a id="anchor1" class="nav-link active" href="hotelStaff_dashboard.php">
                                        ...
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                ...
                                                <div class="text-dark fw-bold h5 mb-0">
                                                    <span>
                                                        <?php
                                                        echo HotelStaff::getReservationCount();
                                                        ?>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                ...
                                                <div class="text-dark fw-bold h5 mb-0">
                                                    <span>
                                                        <?php
                                                        echo HotelStaff::getFacilityCount();
                                                        ?>
                                                    </span>
                                                </div>
                                            </div>
